      ...
      <div class="row justify-content-center">
        <div class="col-md-8">
          <div class="card">
            <div class="card-body">
              <div class="col-6">
                <h3 class="fw-normal text-secondary fs-4 text-uppercase mb-4">Add New User</h3>
                {{--Validation output--}}
                <ul id="form_err"></ul>
                <div id="success_message"></div>
              </div>
              <form method="POST" action="/admin/users" class="needs-validation" name="user_store">
                @csrf
                ...
                <div class="col-3 mb-3">
                  ...
                  <input  name="admin" type="checkbox" class="js-switch"/>
                </div>
